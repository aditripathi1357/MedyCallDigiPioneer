...
class _HospitalProfileScreenState extends State<HospitalProfileScreen> {
  ...
  final List<Map<String, String>> departments = [
    {'name': 'General Physician', 'hours': '9:00 AM to 8:00 PM'},
    {'name': 'Cardiologist', 'hours': '9:00 AM to 8:00 PM'},
    {'name': 'Dermatologist', 'hours': '9:00 AM to 8:00 PM'},
    {'name': 'Cancer specialist', 'hours': '9:00 AM to 8:00 PM'},
    {'name': 'Surgeon', 'hours': '9:00 AM to 8:00 PM'},
    {'name': 'Gynecologist', 'hours': '9:00 AM to 8:00 PM'},
    {'name': 'Orthopedics', 'hours': '9:00 AM to 8:00 PM'},
    {'name': 'Emergency care', 'hours': '9:00 AM to 8:00 PM'},
    {'name': 'Pediatrician', 'hours': '9:00 AM to 8:00 PM'},
    {'name': 'Dentist', 'hours': '9:00 AM to 8:00 PM'},
  ];
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildDepartmentsSection(), // Added departments section
                    const SizedBox(height: 20),
                    buildAboutSection(),
                    const SizedBox(height: 20),
  ...
  // New method to build the departments section
  Widget buildDepartmentsSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
      ...
      children: [
        ...
        Container(
          ...
          child: ClipRRect(
            ...
            child: Image.asset(
              'assets/specialties/hospitalprofile.png',
              fit: BoxFit.cover,
            ),
          ),
        ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Dr. Ani Mallik believes in patient-centric care, ensuring each individual receives personalized treatment plans tailored to their unique needs. By staying updated with the latest advancements in the field and employing evidence-based treatments for the best possible results.',
              style: GoogleFonts.poppins(
                fontSize: 14,
                color: Colors.black87,
                height: 1.5,
